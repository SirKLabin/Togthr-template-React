  ...
  return (
    <div className="home-container">
      ...
      <section className="home-hero">
        ...
        <img
          alt="image"
          src="/external/talk_to_us__8_-removebg-preview-1500h.png"
      ...
      <section className="home-data">
        ...
        <div className="home-content11">
          <div className="home-image09">
            <img alt="image" src="/data-1400w.png" className="home-image10" />
          </div>
        ...
        <div className="home-content27">
          <div className="home-main">
            <div className="home-branding">
              <img alt="image" src="/logo.svg" className="home-image11" />
          ...
          <div className="home-bottom">
            ...
            <button data-role="scroll-top" className="home-button5 button">
              <img alt="image" src="/arrow.svg" className="home-image12" />
            </button>
          </div>
        </div>
      </div>
